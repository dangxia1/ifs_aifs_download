"""Download 2026-04-05 step=0 pressure-level data from Azure, list variables & verify."""
import os
from ecmwf.opendata import Client

TARGET = os.path.join(os.path.dirname(__file__), "data_2026-04-05_step0_levelist.grib2")
PARAMS = ["q", "u", "v", "t"]
LEVELS = [1000, 925, 850, 700, 500, 300, 250, 200, 50]

print(f"Downloading 2026-04-05 step=0 pressure-level data (source=azure) ...")
